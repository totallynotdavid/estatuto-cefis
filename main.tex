...
\Articulo[principios-cefis]{Principios}
...
\Articulo[fines-obj-cefis]{Fines y objetivos}
...
\begin{artitems}
    ...
    \artitem[obj-desarrollo-academico]{Promover y contribuir al desarrollo académico-intelectual, cultural y recreativo dentro de la formación de los estudiantes.}
...
\Articulo[patrimonio-cefis]{Patrimonio del CEFIS}
...
\Articulo[inventario-bienes]{Inventario de bienes}
\begin{artitems}
...
\Articulo[cefis-ambientes]{Uso de ambientes}
...
\Articulo[recursos-financieros]{Recursos financieros}
...
\begin{artitems}
    ...
    \artitem[balance_general_semestral_anual]{Se presenta un Balance General semestral a la Junta de Representantes (JR) y anual a la Asamblea General de Estudiantes (AGE). Toda la documentación financiera (Libro Contable, balances, reportes de cuentas, comprobantes) es parte del Registro Central y accesible para consulta de cualquier agremiado/a habilitado/a, siguiendo el procedimiento establecido por la JD y facilitado por la Secretaría de Actas y Economía.}
    \artitem[egresos_presupuesto_autorizacion]{Los egresos deben estar alineados al presupuesto aprobado por la AGE y ser autorizados formalmente por la JD (registrado en acta de JD), con firma conjunta de la persona titular de la Secretaría General y de la Secretaría de Actas y Economía para montos que superen el umbral definido en el reglamento interno de la JD o, en su defecto, por acuerdo específico y registrado de la JD.}
\end{artitems}

\Articulo[canales-comunicacion]{Canales oficiales de comunicación}
...
\Articulo[definicion-agremiado]{Condición de agremiado/a}
...
\begin{artitems}
    \artitem[perdida-egreso]{Concluir los estudios de pregrado en la E.P. de Física (egreso).}
    ...
    \artitem{Exclusión por falta muy grave, acordada por la AGE conforme al procedimiento del Título VII.}
    \artitem[perdida-por-condicion]{Pérdida definitiva de la condición de estudiante de la E.P. de Física (traslado, expulsión universitaria firme).}
\end{artitems}

\Articulo[deberes-agremiados]{Deberes de los agremiados/as}
...
\begin{artitems}
    ...
    \artitem[recibir_proteccion]{A recibir protección contra represalias por denunciar irregularidades de buena fe (conforme \aref{proteccion_represalias} y \aref{denuncias_buena_fe}).}
\end{artitems}

\Titulo{De la administración y gobierno del CEFIS}

\Articulo[cefis-organos]{Órganos de gobierno}
...
\Articulo[registro-central]{El Registro Central del CEFIS}
\begin{artitems}
    ...
    \begin{enumerate}
        ...
        \subartitem{El inventario de bienes actualizado (\aref{inventario-bienes}°).}
        \subartitem{La documentación financiera completa (Libro Contable, balances, reportes de cuentas, comprobantes) (\aref{recursos-financieros}°).}
        ...
        \subartitem{Registro de denuncias, informes de investigación preliminar (JR) y decisiones finales de AGE en materia disciplinaria (conforme \aref{registro-confidencial}° sobre confidencialidad del registro de sanciones, y la debida reserva en investigaciones según \aref{investigacion-preliminar}).}
        \subartitem{Registro de apelaciones, informes de revisión y decisiones finales (conforme \aref{impugnaciones-apelaciones}°, \aref{apelaciones-no-disciplinarias}°).}
        \subartitem{Registro de las decisiones urgentes adoptadas por la Junta Directiva conforme al \aref{jd-decisiones-urgentes}, incluyendo su justificación, informe a la JR y acta de ratificación por la AGE, si corresponde.}
        \subartitem{Registro de las solicitudes y decisiones de anulación por razones éticas adoptadas por la AGE conforme al Artículo 91°, incluyendo su fundamentación.}
        \subartitem{Actas de transferencia de cargo (\aref{informe-transferencia}°).}
...
La AGE es la máxima instancia deliberativa y decisoria del CEFIS. Está integrada por la totalidad de los agremiados/as habilitados/as conforme al \aref{definicion-agremiado}°.
...
\Articulo[convocatoria-age]{Convocatoria}
...
\begin{artitems}
    \artitem[plazo_emision_convocatoria]{Recibida una solicitud válida (conforme \aref{convocatoria-age}°, numerales 2, 3 o 4), la JD tiene un plazo máximo de cinco (5) días hábiles para emitir la convocatoria o denegarla mediante decisión motivada y registrada en el Registro Central. La denegación se comunica al solicitante y a la JR en el mismo plazo.}
    \artitem[anticipacion_convocatoria]{La convocatoria se publica con la siguiente anticipación mínima:}
    \begin{enumerate}
    ...
    \end{enumerate}
    \artitem{La convocatoria indica fecha, hora, lugar/plataforma, modalidad (presencial, virtual, híbrida), agenda detallada, y si aplica la segunda llamada con quórum reducido. Se difunde por todos los canales oficiales del CEFIS (\aref{canales-comunicacion}°).}
\end{artitems}

\Articulo[age-convocatoria-subsidiaria]{Convocatoria subsidiaria}
Si la persona titular de la Secretaría General no convoca en el plazo (\aref{plazo_emision_convocatoria}) o la deniega sin justificación válida (evaluada por la JR en tres (3) días hábiles, cuya decisión se registra), la Junta de Representantes puede convocar directamente la AGE, cumpliendo los plazos de difusión (\aref{anticipacion_convocatoria}). La convocatoria y la decisión de la JR se registran en el Registro Central.
...
\Articulo[quorum-primera-llamada]{Quórum de instalación (Primera convocatoria - primera llamada)}
Se requiere la presencia verificada (física o virtual) y registrada en acta de:
\begin{artitems}
    \artitem{La persona titular de la Secretaría General y de la Secretaría de Actas y Economía de la JD (o sus reemplazos válidos, \aref{cooperacion-interna-jd}°).}
    \artitem{Personas titulares de Delegaturas o Subdelegaturas que representen a la mayoría simple (mitad más uno) de las bases activas (definidas en \aref{definicion-jr}°).}
...
\Articulo[quorum-segunda-llamada]{Quórum de instalación (Primera convocatoria - segunda llamada)}
...
\Articulo[quorum-segunda-convocatoria]{Quórum de instalación (Segunda convocatoria - reprogramada)}
...
\Articulo[age-min-mayoria]{Adopción de acuerdos y mayorías}
\begin{artitems}
    ...
    \begin{enumerate}
        \subartitem[min-modificar-estatuto]{Modificar el presente Estatuto (\aref{agee_modificar_estatuto}, \aref{mayoria_modificacion_estatuto}).}
        \subartitem[min-disolucion-cefis]{Acordar la disolución del CEFIS (\aref{agee-disolucion-cefis}, \aref{voto_disolucion_cefis}).}
        \subartitem[min-remocion-jd]{Acordar la remoción de miembros de la Junta Directiva por falta grave (\aref{agee-evaluacion_gestion_jd}, \aref{sancion-remocion-cargo}).}%
        \subartitem[min-exclusion-agremiado]{Acordar la exclusión de un/a agremiado/a por falta muy grave (\aref{agee-resolucion_faltas_graves}, \aref{sancion-exclusion-agremiado}).}
        \subartitem[min-anular-decision-etica]{Anular una decisión por razones éticas (\aref{evaluacion_revision_etica}).}
    \end{enumerate}
...
\Articulo{Atribuciones de la Asamblea General Ordinaria (AGE-O)}
...
\begin{artitems}
    ...
    \artitem{Aprobar o modificar el Reglamento de Asambleas y otros reglamentos internos (excepto el Reglamento Electoral, cuya aprobación o modificación corresponde a la AGE-E conforme al \aref{agee-aprobar-reglamento-ce}).}
    \artitem[actualizar-criterios]{Revisar y actualizar formalmente, al menos cada dos (2) años, los criterios de elegibilidad para cargos, los reglamentos internos (incluyendo Asambleas y Electoral) y otros procedimientos documentados, a propuesta de la JD o la JR.}
    \artitem{Tratar otros asuntos de gestión ordinaria y planificación que consten en agenda.}
    \artitem{Interpretar auténticamente el Estatuto (\aref{age-interpretacion-final}).}
\end{artitems}

\Articulo{Atribuciones de la Asamblea General Extraordinaria (AGE-E)}
Son atribuciones principales de la AGE-E:
\begin{artitems}
    \artitem[agee_modificar_estatuto]{Modificar el presente Estatuto (mayoría 2/3, conforme \aref{min-modificar-estatuto}).}
    \artitem[agee-aprobar-reglamento-ce]{Aprobar o modificar el Reglamento Electoral.}
    \artitem[agee-evaluacion_gestion_jd]{Evaluar la gestión y determinar responsabilidades de la JD o sus miembros. Acordar su remoción por causa justificada (mayoría 2/3, conforme \aref{min-remocion-jd}), previo informe documentado y recomendación de la JR o comisión ad hoc designada por la AGE. Se debe garantizar el debido proceso (derecho a descargo, presentación de pruebas), el cual queda registrado en acta (\aref{investigacion-preliminar-proceso}°).}
    ...
    \artitem[agee-resolucion_faltas_graves]{Resolver sobre faltas graves o muy graves de agremiados/as, pudiendo aplicar sanciones incluyendo la exclusión (mayoría 2/3 para exclusión, conforme \aref{min-exclusion-agremiado}), conforme al procedimiento del Título VII, garantizando debido proceso registrado en acta y considerando informe previo de la JR.}
    ...
    \artitem[agee-disolucion-cefis]{Acordar la disolución y liquidación del CEFIS (mayoría 2/3, conforme \aref{min-disolucion-cefis}).}
    \artitem{Cubrir vacancias en la Junta Directiva o el Comité Electoral.}
    \artitem[agee-apelacion-ce]{Resolver, en instancia final y definitiva, apelaciones sobre resoluciones del Comité Electoral únicamente por casos de grave irregularidad probada que vicie sustancialmente el proceso (\aref{ce-decisiones-efectivas}, \aref{ce-apelacion-agee}). La decisión debe ser motivada y registrada en acta.}
    \artitem{Resolver apelaciones sobre decisiones administrativas de la JD que la JR eleve (\aref{apelacion_a_AGE}).}
    \artitem{Resolver solicitudes de anulación de decisiones por razones éticas (\aref{anulacion-etica}°).}
...
\Articulo[definicion-jr]{Definición y composición}
...
\begin{artitems}
    ...
    \artitem{Convocar subsidiariamente a AGE (\aref{age-convocatoria-subsidiaria}°).}
    ...
    \artitem[proteccion_represalias]{Velar por la protección contra represalias de agremiados/as que participen, denuncien o informen de buena fe sobre irregularidades o problemas. Puede canalizar preocupaciones a instancias pertinentes si fuera necesario, manteniendo la confidencialidad si se requiere y registrando la acción tomada.}
    \artitem{Conducir o supervisar revisiones posincidente (\aref{revision-posincidente}°).}
    \artitem{Revisar apelaciones sobre decisiones administrativas de la JD (\aref{apelacion_revision_jr}).}
...
\Articulo[requisitos-jd]{Requisitos para ser miembro de la JD}
Se requiere, con verificación documental por el CE:
\begin{artitems}
    \artitem{Ser agremiado/a habilitado/a del CEFIS (\aref{definicion-agremiado}°).}
    \artitem{Haber aprobado como mínimo treinta y seis (36) créditos del Plan de Estudios de Física.}
    \artitem{No estar incurso en los impedimentos señalados en el \aref{impedimentos-jd}°.}
...
\Articulo[impedimentos-jd]{Impedimentos para ser miembro de la Junta Directiva}
...
\begin{artitems}
    ...
    \artitem{Quienes ocupen simultáneamente un cargo como miembro titular de la Junta de Representantes (\aref{definicion-jr}°).}
...
\begin{artitems}
    ...
    \artitem{Abandono de cargo, declarado por la JD en acta (\aref{inasistencias_abandono_cargo}).}
    \artitem{Sentencia judicial firme por delito doloso.}
    \artitem{Pérdida definitiva de la condición de estudiante de pregrado de la E.P. de Física (\aref{perdida-egreso}, \aref{perdida-por-condicion}).}
    ...
    \artitem{Remoción del cargo por falta grave en sus funciones, declarada por AGE-E (mayoría 2/3, conforme \aref{min-remocion-jd}) con decisión firme registrada en acta.}
    \artitem{Incurrir sobrevenidamente en impedimento (\aref{impedimentos-jd}°), verificado y declarado por la JD en acta, y comunicado a la JR.}
\end{artitems}

\Articulo[jd-reemplazo-vacancia]{Declaración y reemplazo por vacancia}
\begin{artitems}
...
\begin{artitems}
    ...
    \artitem{Administrar diligentemente el patrimonio y los recursos financieros (\aref{patrimonio-cefis}° al \aref{recursos-financieros}°), manteniendo registros contables claros, actualizados y accesibles en el Registro Central. Aprobar egresos presupuestados, registrando las autorizaciones respectivas.}
    \artitem{Gestionar los canales de comunicación oficiales (\aref{canales-comunicacion}°), vía Secretaría de Prensa y Difusión.}%
    ...
    \end{enumerate}
    \artitem{Velar por el correcto uso de los ambientes asignados al CEFIS (\aref{cefis-ambientes}°), aplicando los reglamentos internos correspondientes.}
    \artitem{Las demás que le asigne el Estatuto y la AGE que no sean competencia exclusiva de otros órganos.}
\end{artitems}

\Articulo[informe-transferencia]{Informe final y transferencia de cargo}
...
Las Secretarías son los órganos ejecutores de la JD, cada una con un ámbito de acción definido. La persona titular de cada Secretaría es la máxima responsable de su gestión. Cada Secretaría puede contar con un equipo de apoyo conformado por agremiados/as voluntarios/as, bajo la coordinación y responsabilidad de la persona titular de la Secretaría, conforme al \aref{equipo_apoyo_secretarias}.
...
\begin{artitems}
    ...
    \artitem{Firmar, conjuntamente con la persona titular de la Secretaría de Actas y Economía, la documentación oficial (actas, balances, contratos, convenios) y las autorizaciones de gasto que superen el umbral definido conforme al \aref{egresos_presupuesto_autorizacion}.}
    ...
    \artitem{Activar y justificar formalmente el mecanismo de decisión urgente (\aref{jd-decisiones-urgentes}) cuando sea estrictamente necesario.}
...
\Articulo[secretario-actas-economia]{Secretario/a de Actas y Economía}
...
\begin{artitems}
    \artitem{Redactar y custodiar las actas de las sesiones de la JD y de la AGE, asegurando su correcta elaboración, publicación (\aref{publicacion_archivo_acta}), archivo en el Registro Central y accesibilidad.}
    \artitem{Llevar el registro de asistencia a las sesiones de JD y AGE.}
    \artitem{Administrar los recursos financieros (\aref{recursos-financieros}°) y el presupuesto.}
    \artitem{Llevar el Libro Contable (físico o digital, según se defina) actualizado en el Registro Central (\aref{registro_ingreso_egreso}).}
    ...
    \artitem{Garantizar la transparencia y facilitar el acceso a la información financiera (\aref{balance_general_semestral_anual}).}
    \artitem{Custodiar y actualizar el Inventario de Bienes (\aref{inventario-bienes}°), archivado en el Registro Central.}
    ...
    \artitem{Administrar y mantener el Registro Central (\aref{registro-central}°), asegurando su organización, integridad, seguridad y accesibilidad controlada.}
\end{artitems}
...
\begin{artitems}
    \artitem{Administrar y mantener actualizados los canales oficiales de comunicación (\aref{canales-comunicacion}°), asegurando la coherencia y oportunidad de la información.}
...
\begin{artitems}
    \artitem{Proponer y organizar eventos que contribuyan a los fines del CEFIS (\aref{obj-desarrollo-academico}), llevando un registro de los mismos.}
...
\Articulo[cooperacion-interna-jd]{Cooperación y suplencia}
\begin{artitems}
    ...
    \artitem[equipo_apoyo_secretarias]{Cada Secretaría podrá contar con un equipo de apoyo conformado por agremiados/as voluntarios/as, quienes colaboran bajo la coordinación y responsabilidad de la persona titular de la Secretaría. La conformación de estos equipos se comunica a la JD para su conocimiento y registro. La participación voluntaria es un pilar para el funcionamiento del CEFIS.}
    \artitem{La JD podrá proponer a la AGE la creación de comisiones temporales (\aref{comisiones-naturaleza}°).}
\end{artitems}
...
\begin{artitems}
    ...
    \artitem{Son elegidos por la AGE-O convocada para tal fin, por mayoría simple, entre agremiados/as habilitados/as que cumplan los requisitos (\aref{ce-requisitos}°) y no tengan impedimentos. La postulación es individual.}
...
\Articulo[ce-requisitos]{Requisitos}
...
\begin{artitems}
    ...
    \artitem{Presentar una declaración jurada de no incurrir en los impedimentos del Artículo 65° y de compromiso con la imparcialidad y transparencia del proceso electoral.}
\end{artitems}

\Articulo{Impedimentos}
...
\begin{artitems}
    ...
    \artitem[ce-decisiones-efectivas]{Sus decisiones en materia electoral son de cumplimiento obligatorio. Solo pueden ser revisadas en instancia final por la AGE-E convocada específicamente para tal fin (\aref{agee-apelacion-ce}), únicamente en casos de grave irregularidad debidamente probada que vicie sustancialmente el proceso. La apelación debe seguir el procedimiento establecido en el Reglamento Electoral, y la carga de la prueba recae en quien la impugna.}
\end{artitems}
...
\begin{artitems}
    \artitem{El Padrón Electoral contiene la lista oficial de agremiados/as habilitados/as para votar (\aref{definicion-agremiado}°).}
...
\begin{artitems}
    \artitem{Para la JD, véase el \aref{requisitos-jd}° y \aref{impedimentos-jd}° del presente Estatuto.}
    \artitem{Para el CE, véase el \aref{ce-requisitos}° del presente Estatuto.}
...
\begin{artitems}
    \artitem{La postulación a la JD se realiza mediante listas cerradas y bloqueadas, conforme a los cargos del Artículo 39°.}
...
\begin{artitems}
    ...
    \artitem{Una vez resueltas las impugnaciones presentadas ante el CE (conforme \aref{ce-impugnacion-1ra-instancia}) o vencido el plazo para ello, el CE proclama oficialmente los resultados finales y a los candidatos electos.}
...
\Articulo[impugnaciones-apelaciones]{Impugnaciones y apelaciones electorales}
\begin{artitems}
    \artitem[ce-impugnacion-1ra-instancia]{Sobre la impugnación ante el CE en primera instancia:}
    \begin{enumerate}
    ...
    \end{enumerate}
    \artitem[ce-apelacion-agee]{Sobre la apelación ante la AGE-E en instancia final:}
    \begin{enumerate}
        \subartitem{Las resoluciones del CE solo pueden ser apeladas ante la AGE-E convocada específicamente para tal fin (conforme \aref{agee-apelacion-ce}, \aref{ce-decisiones-efectivas}).}
...
\begin{artitems}
    ...
    \artitem[age-revision-reglamento-electoral]{La AGE revisa formalmente el Reglamento Electoral al menos cada dos (2) años (\aref{actualizar-criterios}).}
\end{artitems}

\Titulo{De las Comisiones de Trabajo}

\Articulo[comisiones-naturaleza]{Naturaleza y creación}
...
\begin{artitems}
    ...
    \artitem{En ningún caso podrán arrogarse funciones decisorias o de representación que correspondan a los órganos de gobierno (\aref{cefis-organos}°). Sus conclusiones o propuestas tienen carácter de recomendación para el órgano que la creó o supervisa.}
\end{artitems}
...
\begin{artitems}
    ...
    \artitem[denuncias_buena_fe]{Los/as agremiados/as que presenten denuncias de buena fe están protegidos contra represalias, conforme a la supervisión de la JR (\aref{recibir_proteccion}, \aref{proteccion_represalias}).}
\end{artitems}

\Articulo[investigacion-preliminar-proceso]{Investigación preliminar}
\begin{artitems}
    ...
    \artitem{Faltas graves o muy graves (procedimiento interno):}
    \begin{enumerate}
        \subartitem{Recibida una denuncia, la JR inicia una investigación preliminar (\aref{jr-investigacion_preliminar_faltas}). Para casos de alta complejidad o que involucren a miembros de la propia JR, esta puede solicitar a la AGE la conformación de una comisión investigadora ad hoc.}
        \subartitem[investigacion-preliminar]{La investigación preliminar tiene como objetivo recabar información y elementos de juicio sobre los hechos denunciados. Incluye, como mínimo, la recopilación de documentos o testimonios pertinentes y la oportunidad para que el/la agremiado/a investigado/a presente sus descargos iniciales por escrito. Se desarrolla con la debida reserva.}
    ...
    \begin{enumerate}
        ...
        \subartitem{Independientemente de la vía externa, si los hechos también constituyen una falta grave o muy grave según el \aref{definicion-faltas}°, la JR puede realizar la investigación preliminar (Art. 86.2.a-d) y, si el/la afectado/a consiente expresamente en seguir también la vía interna del CEFIS o si la falta afecta directamente al gremio (ej. malversación), se puede continuar con el procedimiento sancionador ante la AGE (\aref{procedimiento-sancionador-AGE}°). Las sanciones internas son independientes de las externas.}
    \end{enumerate}
\end{artitems}

\Articulo[procedimiento-sancionador-AGE]{Procedimiento sancionador ante la AGE (faltas graves/muy graves)}
\begin{artitems}
    ...
    \end{enumerate}
    \artitem{Concluida la presentación y el debate, la AGE-E delibera y vota la aplicación o no de una sanción. La decisión sobre la existencia de la falta y la sanción a imponer debe ser adoptada por la mayoría según \aref{age-min-mayoria}° y \aref{sanciones-por-age}°.}
...
\Articulo[sanciones-por-age]{Sanciones aplicables por AGE}
...
\begin{artitems}
    ...
    \artitem[sancion-remocion-cargo]{Remoción del cargo: Destitución de cualquier cargo electivo o de representación dentro del CEFIS. Aplicable a faltas graves o muy graves cometidas en ejercicio del cargo. (Mayoría calificada 2/3, conforme \aref{min-remocion-jd}).}
    \artitem[sancion-exclusion-agremiado]{Exclusión del CEFIS: Pérdida definitiva de la condición de agremiado. Aplicable únicamente a faltas muy graves. (Mayoría calificada 2/3, conforme \aref{min-exclusion-agremiado}).}
\end{artitems}
...
\Articulo[registro-confidencial]{Registro confidencial de sanciones}
\begin{artitems}
...
\Articulo[apelaciones-no-disciplinarias]{Aplicaciones generales (no disciplinarias graves/no electorales)}
\begin{artitems}
    \artitem{Las decisiones administrativas adoptadas por la JD, sus Secretarías o las Comisiones de Trabajo, que no constituyan sanciones por faltas graves o muy graves (\aref{procedimiento-sancionador-AGE}°) ni decisiones del CE (\aref{impugnaciones-apelaciones}°), pueden ser apeladas por cualquier agremiado/a afectado/a.}
    ...
    \artitem[apelacion_revision_jr]{La JR evalúa la apelación, solicita informes que considere necesarios al órgano que emitió la decisión, y emite una recomendación documentada a la JD o a la AGE, según la trascendencia del asunto, en un plazo de quince (15) días hábiles.}
    \artitem[apelacion_a_AGE]{Si la decisión apelada fue de la JD y esta no acoge la recomendación de la JR, o si el asunto es de competencia originaria de la AGE, la JR puede elevar el caso a la siguiente AGE (ordinaria o extraordinaria) para su resolución final. La decisión de la AGE es definitiva en el ámbito del CEFIS y se registra en acta.}
\end{artitems}

\Articulo[anulacion-etica]{Anulación por razones éticas}
\begin{artitems}
    \artitem{Si una decisión o acto de un órgano del CEFIS formalmente correcto respecto al Estatuto o reglamentos produce un resultado manifiestamente injusto, contrario a los principios fundamentales del CEFIS (\aref{principios-cefis}°), o perjudicial para la integridad de la comunidad estudiantil, cualquier agremiado/a, la JD o la JR pueden solicitar su revisión a la AGE-E.}
    ...
    \artitem[evaluacion_revision_etica]{La AGE-E evalúa la solicitud y los antecedentes del caso. Si considera justificada la revisión por razones éticas, puede, por mayoría calificada de dos tercios (2/3) de los agremiados/as presentes y votantes (conforme \aref{min-anular-decision-etica}), confirmar, modificar o anular la decisión o acto original.}
...
\Articulo[revision-posincidente]{Revisiones posincidente}
\begin{artitems}
...
\begin{artitems}
    ...
    \artitem[min-iniciativa-modificacion]{Un número no menor al diez por ciento (10\%) de los agremiados/as habilitados/as, mediante solicitud escrita fundamentada dirigida a la JD, la cual registra su recepción.}
\end{artitems}
...
\begin{artitems}
    ...
    \artitem{La JD es responsable de verificar que la propuesta cumpla los requisitos formales y, en caso de iniciativa de los agremiados (\aref{min-iniciativa-modificacion}), de incluirla obligatoriamente en la agenda de la próxima AGE-E convocada para tal efecto o en una AGE-E específica.}
...
\begin{artitems}
    \artitem{Para la instalación válida de la AGE-E que trate la modificación del Estatuto, se aplican las reglas de quórum establecidas (\aref{quorum-primera-llamada}°, \aref{quorum-segunda-llamada}° y \aref{quorum-segunda-convocatoria}°).}
    \artitem[mayoria_modificacion_estatuto]{La aprobación de cualquier modificación al presente Estatuto requiere el voto favorable de una mayoría de dos tercios (2/3) de agremiados/as habilitados/as presentes y votantes en la AGE-E (\aref{min-modificar-estatuto}, \aref{agee_modificar_estatuto}). La votación es registrada en acta.}
\end{artitems}
...
\begin{artitems}
    ...
    \artitem{Por imposibilidad manifiesta y permanente de cumplir con los fines y objetivos establecidos en el \aref{fines-obj-cefis}° del presente Estatuto, declarada formalmente por la AGE-E.}
\end{artitems}
...
\begin{artitems}
    ...
    \artitem[voto_disolucion_cefis]{La decisión de disolver el CEFIS requiere el voto favorable de una mayoría de dos tercios (2/3) de agremiados/as habilitados/as presentes y votantes en la AGE-E válidamente instalada (\aref{min-disolucion-cefis}, \aref{agee-disolucion-cefis}). La votación será nominal y registrada en acta.}
\end{artitems}
...
\begin{artitems}
    ...
    \begin{enumerate}
        ...
        \subartitem{Distribuir el patrimonio remanente conforme a lo establecido en el Artículo 101°.}
    \end{enumerate}
...
\Articulo{Destino del patrimonio remanente}
\begin{artitems}
...
\begin{artitems}
    \artitem[age-interpretacion-final]{La interpretación auténtica y definitiva de las disposiciones del presente Estatuto corresponde exclusivamente a la AGE, adoptada por mayoría simple en sesión ordinaria o extraordinaria.}
